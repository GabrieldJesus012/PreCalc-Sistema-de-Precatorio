...
Private Sub UserForm_Initialize()
    PreferenciaBox.AddItem "PREFERÊNCIAS"
    ...
    SemModeloBox.AddItem "SEM MODELO"
    SemModeloBox.AddItem "CRIAR MODELO"
    OrdemBox.AddItem "ORDEM"
    ...
    PreferenciaBox1.AddItem "PREFERÊNCIAS"
...
Private Sub NPrecatorio_Change()
    ...
    End If
    ThisWorkbook.Sheets("Menu").Range("NumeroPrecatorio").Value = Me.NPrecatorio.Text
End Sub
...
Private Sub PreferenciaBox_Change()
    AbrirPlanilha
End Sub

Private Sub AcordoBox_Change()
    AbrirPlanilha
End Sub

Private Sub OrdemBox_Change()
    AbrirPlanilha
End Sub

Private Sub PreferenciaBox1_Change()
    AbrirPlanilha
End Sub
Private Sub AbrirPlanilha()
    ...
    ' Se um arquivo foi selecionado, perguntar ao usuário se deseja abrir
    If caminhoArquivo <> "" Then
        If MsgBox("Você deseja abrir a planilha?", vbYesNo) = vbYes Then
